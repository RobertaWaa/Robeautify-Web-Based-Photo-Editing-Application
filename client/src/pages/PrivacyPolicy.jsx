  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p className="mb-4">
          Welcome to Robeautify ("we," "our," or "us"). We are committed to
          protecting your privacy and personal information. This Privacy Policy
          explains how we collect, use, disclose, and safeguard your information
          when you use our photo editing application and website (the
          "Service").
        </p>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">
          4. Photo Privacy and Storage
        </h2>
        <p className="mb-4">
          <strong>Your photos are private.</strong> We do not view, share, or
          sell your uploaded or edited photos without your explicit permission.
          Your photos are stored securely and are only accessible by you through
          your account. We do not use your photos for training algorithms or for
        ...
        <p className="mb-4">
          We retain your personal information and edited photos for as long as
        ...
        <p className="mb-4">
          ...
          third-party services. We encourage you to read the privacy policies of
          any third-party service that you visit or use.
        </p>
