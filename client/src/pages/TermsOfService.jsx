  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p className="mb-4">
          By accessing or using Robeautify's photo editing application and
          website (the "Service"), you agree to be bound by these Terms of
        ...
        <p className="mb-4">
          Robeautify is a photo editing application that allows users to upload,
          edit, and save photos. Users can apply filters, make adjustments,
          crop, rotate, and perform other editing functions on their photos.
        </p>
        ...
        <p className="mb-4">
          You retain all rights to the photos you upload to our Service. By
          uploading photos to our Service, you grant us a limited license to
          store, process, and display your photos solely for the purpose of
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            Contains illegal, obscene, defamatory, threatening, or harassing
            content
          </li>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            Attempt to reverse engineer or extract the source code of our
            software
          </li>
        </ul>
        ...
        <p className="mb-4">
          ...
          is incorporated by reference into these Terms of Service. Please
        ...
        <p className="mb-4">
          ...
          exclusive property of Robeautify. The Service is protected by
        ...
        <p className="mb-4">
          ...
          whatsoever, including but not limited to a breach of these Terms. Upon
        ...
        <p className="mb-4">
          In no event shall Robeautify be liable for any indirect, incidental,
        ...
        <p className="mb-4">
          ...
          Robeautify expressly disclaims all warranties of any kind, whether
