        ...
        return (
            <Container>
                <FormContainer>
                    ...
                    <ErrorMessage>The password reset link is invalid or has expired.</ErrorMessage>
                    <Link to="/forgot-password" style={{ color: '#ff69b4', marginTop: '20px', display: 'inline-block' }}>
